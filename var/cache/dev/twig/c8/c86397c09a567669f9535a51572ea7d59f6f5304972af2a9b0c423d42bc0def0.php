...
class __TwigTemplate_99d7afeb2ef9f69d0dfa2764e6d53976c4debf987ea4a6a85e42b16f7a4fa251 extends \Twig\Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, [], \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/opt/lampp/htdocs/learn/symfony-project/auth/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}

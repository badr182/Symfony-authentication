...
class __TwigTemplate_b0c801b1d2f085fccdaea537daeb3ec55e93bfa174b5b0f8057a14202ddc780c extends \Twig\Template
{
    private $source;
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, [], \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/opt/lampp/htdocs/learn/symfony-project/auth/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
